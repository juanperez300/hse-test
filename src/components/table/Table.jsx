...
function DatasTable() {
  const { lookfor, setLookfor, filter, outcome, setOutcome } =
...
function EnhancedTableHead(props) {
  ...
  React.useEffect(() => {
    const buscar = lookfor.name;
    const resultado = rows.find((elemento) =>
      elemento.name.toLowerCase().includes(buscar.toLowerCase())
    );
